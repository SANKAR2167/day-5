...
let resultArray =(function (arrNumber){
    ...
    return (arrNumber.filter((item) =>{return item % 2 !== 0}))})(arrNumber);
...
let stringArray = ["Sankar", "is", "a", "Full","stack","web", "developer"]
...
console.log("Odd Numbers in Number Array are: " + numberArr.filter((item) => {return item % 2 !== 0}));
